...
export default function Navbar({logOut}) {
 let token= localStorage.getItem("token");
  ...
  <ul className="dropdown-menu border-0 "  aria-labelledby="dropdownMenu2">
  <li className='li-arrow' id=''></li>
  ...
  <li className='li-arrow3' id=''></li>
   ...
   <li className="nav-item">
     ...
     <ul className="navbar-nav ms-auto mb-2  mb-lg-0 "> 
      <li className="nav-item">
      <NavLink className={({isActive})=>isActive?"acive nav-link btn btn-outline-primary text-primary ms-2":"nav-link btn btn-outline-primary text-primary ms-2"} onClick={logOut} to="/">Log Out</NavLink>
      </li>
         </ul>
